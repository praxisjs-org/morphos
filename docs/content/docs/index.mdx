...
<Cards>
  ...
  <Card title="Icons · 2" href="/docs/icons/icon" description="Icon, IconProvider." />
</Cards>
...
| Component | Description |
|---|---|
| `Icon` | Renders an icon by name, resolved against the configured provider — warns and renders nothing until one is set |
| `IconProvider` | Sets the icon provider for every `Icon` beneath it — mandatory, no default (`LucideSource` included) |
