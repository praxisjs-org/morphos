...
<Cards>
  ...
  <Card title="Icons · 3" href="/docs/icons/icon" description="Icon, LucideIcon, PhosphorIcon." />
</Cards>
...
| `LucideIcon` | Renders icon data from the `lucide` package |
| `PhosphorIcon` | Renders a raw SVG asset from `@phosphor-icons/core` |
